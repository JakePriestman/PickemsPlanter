...
public interface IUserPredictionsCachingService
{
	...
	Task<string> GetAuthCodeFromCacheAsync(string eventId, string steamId);
...
public class UserPredictionsCachingService(IMemoryCache cache, ISteamAPI steamAPI, ITournamentCachingService tournamentCachingService, IUserEventsTableService tableService) : IUserPredictionsCachingService
{
	...
	public async Task<string> GetAuthCodeFromCacheAsync(string eventId, string steamId)
	{
	...
	public async Task<UserPredictions> RefreshUserPredictionsAsync(string steamId, string eventId)
	{
		...
		string authCode = await GetAuthCodeFromCacheAsync(eventId, steamId);
